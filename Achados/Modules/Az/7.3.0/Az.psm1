...
$module = Get-Module Az.Accounts 
        if ($module -ne $null -and $module.Version -lt [System.Version]"2.7.3") 
{ 
    Write-Error "This module requires Az.Accounts version 2.7.3. An earlier version of Az.Accounts is imported in the current PowerShell session. Please open a new session before importing this module. This error could indicate that multiple incompatible versions of the Azure PowerShell cmdlets are installed on your system. Please see https://aka.ms/azps-version-error for troubleshooting information." -ErrorAction Stop 
} 
elseif ($module -eq $null) 
{ 
    Import-Module Az.Accounts -MinimumVersion 2.7.3 -Scope Global 
}
...
Import-Module Az.Compute -RequiredVersion 4.24.0 -Global
...
Import-Module Az.DataFactory -RequiredVersion 1.16.4 -Global
...
Import-Module Az.KeyVault -RequiredVersion 4.3.0 -Global
...
Import-Module Az.Network -RequiredVersion 4.15.0 -Global
Import-Module Az.NotificationHubs -RequiredVersion 1.1.1 -Global
Import-Module Az.OperationalInsights -RequiredVersion 3.0.1 -Global
...
Import-Module Az.RecoveryServices -RequiredVersion 5.2.0 -Global
...
Import-Module Az.Synapse -RequiredVersion 1.1.0 -Global
Import-Module Az.TrafficManager -RequiredVersion 1.1.0 -Global
Import-Module Az.Websites -RequiredVersion 2.10.0 -Global
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBiOK9fiN/kNYYI
# 58ma4s0ozYV1kJP1qSKNKWc4alpV5KCCDYEwggX/MIID56ADAgECAhMzAAACUosz
...
# BgEEAYI3AgELMQ4wDAYKKwYBBAGCNwIBFTAvBgkqhkiG9w0BCQQxIgQgc5p3ymZS
# jEVuiPm06QgY9bc9zXXrFCWxOni0I2yVv8cwQgYKKwYBBAGCNwIBDDE0MDKgFIAS
# AE0AaQBjAHIAbwBzAG8AZgB0oRqAGGh0dHA6Ly93d3cubWljcm9zb2Z0LmNvbTAN
# BgkqhkiG9w0BAQEFAASCAQAQ2JwDUWHc5zAvksy5vLQRtLfRm5wJJMItZ73VN3OB
# RR/A14gD3/pHNai2cZCfMEN0qFFclOKQYGk9sbGsP8Mr8GbunB0E+lmL1WzzP7Ox
# U2mWLRM2MntZL6nsoE2Jk24imQyDQgryo4/7F0qkWr2jLpLRJhJ8166PkMRafavq
# wmdCOOC84YIycvuk+KMFU0YlsGj9VJZDUNuUvms8c8stDWZikXJLbp5z67iTT6wc
# keT7xEReKQ/2T6PApOUAotkpHzDr02NV9Pkm4pSy/t3kyJf8/gpp9MlTOa49Ge/0
# 1qQw1TNS+HhgTStBxV/FU2OBFIFa4EHNsslcYHdJc9mzoYIXGTCCFxUGCisGAQQB
# gjcDAwExghcFMIIXAQYJKoZIhvcNAQcCoIIW8jCCFu4CAQMxDzANBglghkgBZQME
# AgEFADCCAVkGCyqGSIb3DQEJEAEEoIIBSASCAUQwggFAAgEBBgorBgEEAYRZCgMB
# MDEwDQYJYIZIAWUDBAIBBQAEIHnrJ4oLvtUjKQcbALsq0BvDYrs0Q+Sw0vHsX7rI
# BCe8AgZiF5Xkr5sYEzIwMjIwMjI1MTM1MDQ5LjQyOVowBIACAfSggdikgdUwgdIx
...
# SjAaBgkqhkiG9w0BCQMxDQYLKoZIhvcNAQkQAQQwLwYJKoZIhvcNAQkEMSIEINZ9
# vL5mFWXBCC5QsSI/Afvgl1NpPg6nFEhvvWsnMJO1MIH6BgsqhkiG9w0BCRACLzGB
...
# hkiG9w0BAQsFAASCAgAJqzSZt0mOlXsFfc0OCQVdkT6f0ZUq4hDkI/l/kV6PgPaJ
# US9SkMkkboeRygjm006VG+QiFFL84jTKBR1oJpIlC+bBmHjwV8uXEoOuno0MVsDD
# hJc3HDvL23/6yLgBJW83+eEPmwAruxGycRWyb3jNZO2pd7ql5lWvNpIjPOm+EXJV
# CUf2DWOa6GBp5+UIIimr5ErFjCXMZWOxmGMjIaRnzkiDt0sQ+WnPRNTmbYlS6ZZl
# yBvy6RgL66BWIRLUOlW52viJF0XnSlgxyx6WmrVDZjzLXb8lVByYCjl6jxhIJuHl
# dPeUEkhGV5mwgUoL4V53NzTFrUBAzHDD1JNC1nFawNsEsHzMHTuA/lwrfdjh1RPe
# 1IfanrEwe523ESh4dMuCG1Mve2RtuEyV64GzKdbSMyQIUtou84KGcAJOC3s0jQUa
# b6+laTdz5TJ7GeC9P/0XZVSFPrbc+sfaxmaev7rSdrJ241PQ1/Brqgy/oJKJyDdb
# eg2Z2sfLiFrsUNirIIW1mkaMP8VBowl+15iV+7Tph/CLP+sg0S7TqsGOJi/Hh6Po
# E6HKCQKn2AmjOtgMzGI9lSO/ljJScEMJeNZr5enJoshGrs6Q3CIMvdmQMYItaGmD
# 2jl49LeDiSGZW5m9YkmNZHEpF5pLe0sUn2PvbMQrmalY9+7CcgmBfq1wFzj06w==
